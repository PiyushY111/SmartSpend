    ...
    >
      ...
      <div className="mt-8 space-y-4">
        ...
        {goals.length > 0 ? (
                ...
                <div className="relative z-10">
                  ...
                  <div className="mt-3 flex items-center space-x-2">
                    ...
                    <button 
                      ...
                      className="btn btn-primary py-2 px-4 rounded-lg bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-semibold shadow-lg hover:from-indigo-600 hover:to-purple-600 transition-all duration-300 relative overflow-hidden group"
                    >
                      <motion.div
                        className="absolute inset-0 bg-gradient-to-r from-indigo-600 to-purple-600"
                        initial={{ x: "-100%" }}
          ...
          >
            <p>No financial goals set yet. Start by adding your first goal!</p>
          </motion.div>
        )}
      </div>
    </motion.div>
